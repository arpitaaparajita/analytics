...
str(Groceries)
Groceries
arules::LIST(Groceries[1:6])  #another view, which items were purchased in 6 transactions
arules::inspect(Groceries[1:5]) # another view , items shown in a list
...
itemFrequencyPlot(Groceries,topN = 15,type="absolute") # topN means top 15 items
...
#52% of the people who bought baking powder, bought whole milk also and this group was bought for total of 91 times
rules
inspect (rules[1:5])
