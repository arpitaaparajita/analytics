...
#Yearly----
(yearlysales = ts(sales, start=c(1980), frequency=1)) #automatically 36 observation is compiled yearly data, as start is 1980
...
(qsales=window(qtrsales, start=c(1980, 3), end=c(1985, 2)))
plot(qsales)
