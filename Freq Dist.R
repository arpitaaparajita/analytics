...
x3
#x3[1] = 60; x3[2] = 75
x3.cut = cut(x3, breaks) #cutting the original vector into break points
x3.cut
table(x3.cut) #frequency table is created
...
(x3a = table(x3.cut)) # define in levels , high income group low income group
(x3b = cbind(x3a))
