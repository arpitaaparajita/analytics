...
#read file : Method1
sales1 = read.csv("./Data/denco.csv") #goto repository-> data
...
#dplyr
names(sales) #name of columns, keep understanding dataset, 1pg printout and keep looking at variables
...
#give tail to find least revenue
...
# Filter Data----
#tell me the customers who gave us revenue according to condition
