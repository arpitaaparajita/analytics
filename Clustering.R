...
km1
km1$iter # no. of iterations to create cluster-
km1$betweenss # between ss is distance between centroid of 2 clusters
km1$tot.withinss
km1$withinss # sum squares of eucledian dist of points from centroid within each cluster
